  ...
  >
    ...
    <div class="">
      <textarea
        ...
        class="rounded-lg px-3 object-fill text-gray-600 focus:outline-none"
        :value="todo.todo"
        style="resize: none"
        rows="10"
      />
      <p
        v-else
        class="text-gray-700 pe-9 text-justify"
    ...
    <div
      class="flex gap-3 relative right-3 group-hover:opacity-100 opacity-0 transition duration-500"
    >
      <Icon
        icon="ph:pen-fill"
